...
namespace Database {
	...
	struct ItemModifier {
		...
		ItemModifier(int _ID, std::string _Name, int _Tier, int _TypeID, int _Flags,
						float _CoefMinValue1, float _CoefMaxValue1, float _CoefMinValue2, float _CoefMaxValue2,
						float _CoefMinValue3, float _CoefMaxValue3, int _Weight, int _ItemLevel, std::string _Format) :
			ID(_ID), Name(_Name), Tier(_Tier), TypeID(_TypeID), Flags(_Flags), CoefMinValue1(_CoefMinValue1), CoefMaxValue1(_CoefMaxValue1),
			CoefMinValue2(_CoefMinValue2), CoefMaxValue2(_CoefMaxValue2), CoefMinValue3(_CoefMinValue3), CoefMaxValue3(_CoefMaxValue3),
			Weight(_Weight), ItemLevel(_ItemLevel), Format(_Format) {}
